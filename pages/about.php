...
<body>
  ...
  <section class="about-hero">
    ...
    <div class="hero-content reveal fade-up">
      <h1 class="reveal fade-up">Welcome to <span class="highlight-yellow">Divine Confidence School</span></h1>
      <p class="reveal fade-up" style="--delay: .08s">
        Divine Confidence Nursery, Primary and Secondary School has spanned over 19 years, with excellent academic achievements, result-oriented club activities, sporting engagements and emphasis on sound moral upbringing, which have endeared parents to enroll their children/wards. The same zeal is going into the secondary school for more outstanding results.
      </p>
      <a href="https://dcsschools.com/pages/enrollment.php" class="btn-hero-enroll reveal fade-up" style="--delay: .14s" target="_blank" rel="noopener">Apply for Admission &rarr;</a>
    </div>
  </section>

  <section class="who-we-are-section">
    <div class="container">
      <h2 class="section-title-left reveal fade-up">Who We Are</h2>
      <div class="who-we-are-text reveal fade-up" style="--delay: .06s">
        <p class="reveal fade-up" style="--delay: .08s">Born out of vision, <strong>Divine Confidence College</strong> is the Secondary arm of <strong>Divine Confidence Nursery and Primary school</strong>, with the sole aim to produce the whole student. Following our experience and outstanding results in the Nursery and Primary arms, Divine Confidence College was birthed.</p>
        <p class="reveal fade-up" style="--delay: .12s">DCC is a Christian based co-educational school, built on the principles of God Almighty and where Christian practices are greatly emphasized. Through our curricular, the school is poised to produce the caliber of students who have undergone both spiritual and academic mentorship, with the instillation of correct societal values in the student.</p>
        <p class="reveal fade-up" style="--delay: .16s">DCC ensures that her students are equipped with basic skills, including soft skills, required to adapt to any environment they go to. Just as we put God first, every student is taught to recognize the God-factor in every activity undertaken. With carefully selected qualified, professional staff members and infrastructures, DCC is set to bring out the best in every student because we recognize that every child is a threshold of potentials.</p>
        <p class="reveal fade-up" style="--delay: .2s">DCC is co-educational and regardless of your background, religion and race, you are welcome to have a wonderful DCC experience.</p>
      </div>
    </div>
  </section>
  ...
  <section class="history-section">
    <div class="container history-grid">
      <div class="history-content reveal fade-up">
        <h2 class="section-title-left reveal fade-up">Brief History</h2>
        <p class="reveal fade-up" style="--delay: .06s">Divine Confidence School was established in February 1st, 2006 by the grace of God the Almighty upon the visioneer <strong>Mrs. Folashade Johnson.</strong></p>
        <p class="reveal fade-up" style="--delay: .1s">The school was born out of her profound passion for qualitative, sound and affordable all round education that is devoid of any form of discrimination and inequality for the school age children in Ikotun - Abaranje and all her environs.</p>
        <p class="reveal fade-up" style="--delay: .14s">This passion for the provision of such education became a compulsion because of the disparity noticed in the performances of children in the environment when compared to their affluent counterparts in other areas.</p>
        <p class="reveal fade-up" style="--delay: .18s">In the light of this, the need to set up a standard school that is uniquely child centred and equipped with the capacity to develop maximally the three major domains of child development became a non negotiable necessity.</p>
        <p class="reveal fade-up" style="--delay: .22s">The school gate was however opened for her first set of pupils on Monday, 1st of February, 2006. With 2 pioneer pupils: Joy Oluwakanyinsola Johnson and Oladimeji Temiloluwa.</p>
      </div>
      <div class="history-image reveal zoom-in" style="--delay: .1s">
        <img src="../assets/images/sign.png" alt="Divine Confidence School Building" class="reveal zoom-in" style="--delay: .14s">
      </div>
    </div>
  </section>

  <section class="values-section">
    <div class="container values-grid reveal fade-up">
      ...
      <div class="value-card reveal zoom-in" style="--delay: .12s">
        <h3>Vision</h3>
        <p>To promote education with qualitative values.</p>
      </div>
      <div class="value-card reveal zoom-in" style="--delay: .16s">
        <h3>Core Values</h3>
  ...
  <section class="proprietress-section">
    <div class="container">
      <h2 class="section-title-center reveal fade-up">Welcome Address from the Proprietress</h2>
      <div class="proprietress-content reveal fade-up" style="--delay: .06s">
        <div class="proprietress-text reveal fade-up" style="--delay: .08s">
          <p class="reveal fade-up" style="--delay: .1s"><strong>Welcome to Divine Confidence Nursery and Primary School.</strong></p>
          <p class="reveal fade-up" style="--delay: .12s">Divine Confidence is a school founded on faith, purpose, and a deep commitment to raising children who are confident in character, strong in values, and sound in learning. From the very beginning, our focus has been on combining moral upbringing with academic excellence, ensuring that every child entrusted to us receives a balanced and meaningful education.</p>
          <p class="reveal fade-up" style="--delay: .16s">We believe that the foundation of true learning begins with the fear of God, respect for others, and a strong sense of responsibility. These values guide our teaching, our relationships, and our daily interactions with our pupils. Beyond academics, we are intentional about shaping attitudes, building confidence, and preparing our children to face each stage of life with wisdom and courage.</p>
          <p class="reveal fade-up" style="--delay: .2s">At Divine Confidence, we value the partnership between the school and the home. We work closely with parents and guardians to create a supportive environment where children can thrive both academically and morally. This shared responsibility allows us to nurture discipline, good study habits, and positive character traits that stay with our pupils long after they leave our classrooms.</p>
          <p class="reveal fade-up" style="--delay: .24s">Our dedicated teachers are committed to continuous growth and effective teaching practices, ensuring that each child is taught with care, patience, and excellence. Through a broad curriculum and enriching extracurricular activities, we give our pupils opportunities to discover their talents, develop their abilities, and grow holistically.</p>
          <p class="reveal fade-up" style="--delay: .28s">We are encouraged by the progress of our pupils and the positive testimonies that follow them as they advance in their educational journey. These outcomes reaffirm our belief that when children are guided with love, discipline, and godly values, excellence naturally follows.</p>
          <p class="reveal fade-up" style="--delay: .32s">I warmly invite you to become part of the Divine Confidence family, where faith, learning, and character development come together to build a solid foundation for the future, with God at the center of it all.</p>
          <div class="proprietress-sign reveal fade-up" style="--delay: .36s">
            <h4>Mrs. Folashade Johnson</h4>
            <span>Proprietress</span>
          </div>
        </div>
        <div class="proprietress-image reveal zoom-in" style="--delay: .1s">
          <img src="../assets/images/pro1.png" alt="Mrs. Folashade Johnson" class="reveal zoom-in" style="--delay: .14s">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="academics-curriculum-section">
    <div class="container">
      ...
      <div class="academics-text reveal fade-up" style="--delay: .06s">
        <p class="reveal fade-up" style="--delay: .08s">Born out of vision, <strong>Divine Confidence College</strong> is the Secondary arm of <strong>Divine Confidence Nursery and Primary school</strong>, with the sole aim to produce the whole student. Following our experience and outstanding results in the Nursery and Primary arms, Divine Confidence College was birthed.</p>
        <p class="reveal fade-up" style="--delay: .12s">DCC is a Christian based co-educational school, built on the principles of God Almighty and where Christian practices are greatly emphasized. Through our curricular, the school is poised to produce the caliber of students who have undergone both spiritual and academic mentorship, with the instillation of correct societal values in the student.</p>
        <p class="reveal fade-up" style="--delay: .16s">DCC ensures that her students are equipped with basic skills, including soft skills, required to adapt to any environment they go to. Just as we put God first, every student is taught to recognize the God-factor in every activity undertaken. With carefully selected qualified, professional staff members and infrastructures, DCC is set to bring out the best in every student because we recognize that every child is a threshold of potentials.</p>
        <p class="reveal fade-up" style="--delay: .2s">DCC is co-educational and regardless of your background, religion and race, you are welcome to have a wonderful DCC experience.</p>
  ...
  <section class="community-section">
    <div class="container">
      <h2 class="section-title-center reveal fade-up">Our Community</h2>
      <div class="community-intro reveal fade-up" style="--delay: .06s">
        <p class="reveal fade-up" style="--delay: .08s">DCC parades a community where the Christian orientation thrives. At DCC, the environment is conducive to ensure the students get the academic orientation and will make them able to face life challenges, providing solutions to them and fit in diverse environments.</p>
        <p class="reveal fade-up" style="--delay: .12s">Well equipped infrastructures that include well equipped Science Laboratories, ICT room, Music room, Home-Economics laboratory etc. are put in place to ensure standardized tutoring to students, with effective supervision by staff, who are poised to engineer the creative abilities of the students.</p>
        <p class="reveal fade-up" style="--delay: .16s">Just as we create a sound environment for the students, the parents are not left behind, as the vibrancy of the Parents' Partnership Forum (PPF) is geared towards the students' benefit.</p>
      </div>
      <div class="community-gallery reveal fade-up" style="--delay: .06s">
        <div class="community-img-wrapper reveal zoom-in" style="--delay: .08s"><img src="../assets/images/comm1.png" alt="Community 1"></div>
        <div class="community-img-wrapper reveal zoom-in" style="--delay: .12s"><img src="../assets/images/comm2.png" alt="Community 2"></div>
        <div class="community-img-wrapper reveal zoom-in" style="--delay: .16s"><img src="../assets/images/comm3.png" alt="Community 3"></div>
      </div>
    </div>
  </section>
  ...
  <section class="cta-section">
    <div class="cta-container reveal fade-up">
      ...
      <a href="https://dcsschools.com/pages/enrollment.php" class="btn-cta-enroll reveal fade-up" style="--delay: .12s" target="_blank" rel="noopener">Enroll Now &rarr;</a>
    </div>
  </section>
