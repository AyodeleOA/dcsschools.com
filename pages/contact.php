...
<body>
  ...
  <section class="contact-hero">
    ...
    <div class="contact-hero-grid reveal fade-up" style="--delay: .06s">
      ...
      <div class="contact-hero-image reveal zoom-in" style="--delay: .1s"><img src="../assets/images/contact.png" alt="contact hero" class="contact-hero-img reveal zoom-in" style="--delay: .14s"></div>
    </div>
