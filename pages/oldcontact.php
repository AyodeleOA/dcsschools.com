...
<body>
  ...
  <section class="contact-hero">
    <p class="contact-label reveal fade-up">CONTACT US</p>
    <div class="contact-hero-grid reveal fade-up" style="--delay: .06s">
      <div class="contact-intro reveal fade-up" style="--delay: .08s">
        <h2 class="contact-title reveal fade-up" style="--delay: .1s">Get in Touch With Us</h2>
        <p class="contact-subtext reveal fade-up" style="--delay: .14s">If you have questions about admissions, programs, fees, or anything else about the school, reach out. Our team is always happy to guide parents, students, and partners.</p>
        <div class="contact-details reveal fade-up" style="--delay: .18s">
          <div class="contact-detail reveal fade-up" style="--delay: .2s"><img src="../assets/images/location.png" alt="Location" class="contact-detail-icon"><span class="contact-detail-text"><?php echo isset($settings['address']) ? htmlspecialchars($settings['address']) : ''; ?></span></div>
          <div class="contact-detail reveal fade-up" style="--delay: .24s"><img src="../assets/images/mail.png" alt="Email" class="contact-detail-icon"><span class="contact-detail-text"><?php echo isset($settings['email']) ? htmlspecialchars($settings['email']) : ''; ?></span></div>
          <div class="contact-detail reveal fade-up" style="--delay: .28s"><img src="../assets/images/call.png" alt="Phone" class="contact-detail-icon"><span class="contact-detail-text"><?php echo isset($settings['phone']) ? htmlspecialchars($settings['phone']) : ''; ?></span></div>
        </div>
      </div>
      <div class="contact-hero-image reveal zoom-in" style="--delay: .1s"><img src="../assets/images/contact-us.png" alt="contact hero" class="contact-hero-img reveal zoom-in" style="--delay: .14s"></div>
    </div>
    <div class="contact-divider"></div>
  </section>

  <section class="contact-form-section">
    <p class="form-label reveal fade-up">Send Us a Message</p>
    <p class="form-subtext reveal fade-up" style="--delay: .06s">We would Love to hear From You, Enquirers, Observations, Place an order.</p>
    <form id="contact-form" class="contact-form reveal fade-up" style="--delay: .08s">
      <div class="form-row">
        <label class="form-field reveal fade-up" style="--delay: .1s"><span class="form-field-label">Name *</span><input type="text" name="name" placeholder="Enter Name" required /></label>
        <label class="form-field reveal fade-up" style="--delay: .14s"><span class="form-field-label">Email *</span><input type="email" name="email" placeholder="Enter Email" required /></label>
        <label class="form-field reveal fade-up" style="--delay: .18s"><span class="form-field-label">Phone Number *</span><input type="tel" name="phone" placeholder="Enter Phone Number" required /></label>
      </div>
      <label class="form-field form-field-full reveal fade-up" style="--delay: .22s"><span class="form-field-label">Enter your Message *</span><textarea name="message" placeholder="Type Here" maxlength="1000" required></textarea>
        <div class="char-count"><span id="char-count">0</span>/1000</div>
      </label>
      <div class="form-actions reveal fade-up" style="--delay: .26s"><button type="submit" class="btn-submit" id="contact-btn">Send Message</button></div>
    </form>
  </section>
  ...
  <section class="faq-section">
    <p class="faq-label reveal fade-up">FAQ</p>
    <div class="faq-grid reveal fade-up" style="--delay: .06s">
      <div class="faq-left reveal fade-up" style="--delay: .08s">
      ...
      <div class="faq-right reveal fade-up" style="--delay: .12s">
        <?php foreach ($faqs as $f): ?>
          <div class="faq-item reveal fade-up" style="--delay: .14s">
