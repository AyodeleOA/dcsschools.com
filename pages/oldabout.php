  ...
  <section class="history-section">
    <div class="container history-grid">
      <div class="history-content reveal fade-up">
        ...
        <p class="reveal fade-up" style="--delay: .06s">Divine Confidence School was established in September 2009 by the grace of God the Almighty upon the visioneer <strong>Mrs. Folashade Johnson.</strong></p>
        ...
        <p class="reveal fade-up" style="--delay: .22s">The school gate was however opened for her first set of pupils on the 15th of September, 2009 with 2 pioneer pupils: Joy Oluwakanyinsola Johnson and Oladimeji Temiloluwa.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="proprietress-content reveal fade-up" style="--delay: .06s">
        ...
        <div class="proprietress-image reveal zoom-in" style="--delay: .1s">
          <img src="../assets/images/pro.png" alt="Mrs. Folashade Johnson" class="reveal zoom-in" style="--delay: .14s">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="community-section">
    <div class="container">
      ...
      <div class="community-gallery reveal fade-up" style="--delay: .06s">
        <div class="community-img-wrapper reveal zoom-in" style="--delay: .08s"><img src="../assets/images/abt1.png" alt="Community 1"></div>
        <div class="community-img-wrapper reveal zoom-in" style="--delay: .12s"><img src="../assets/images/abt2.png" alt="Community 2"></div>
        <div class="community-img-wrapper reveal zoom-in" style="--delay: .16s"><img src="../assets/images/abt3.png" alt="Community 3"></div>
      </div>
    </div>
  </section>
