...
<body>
  ...
  <section class="academics-overview">
    <div class="container">
      <h2 class="section-title-left">Overview of Our Academic Programme</h2>
  ...
  <section class="academics-track">
    <div class="container">
      <h2 class="section-title-left"><?php echo htmlspecialchars($card['title']); ?></h2>
      ...
      <div class="gallery-row">
        ...
        <div class="gallery-card"><img src="../<?php echo htmlspecialchars($card['image_path_1']); ?>" alt="<?php echo htmlspecialchars($card['title']); ?> 1"></div>
        <?php endif; ?>
        <?php if (!empty($card['image_path_2'])): ?>
        <div class="gallery-card"><img src="../<?php echo htmlspecialchars($card['image_path_2']); ?>" alt="<?php echo htmlspecialchars($card['title']); ?> 2"></div>
        <?php endif; ?>
      </div>
      <div class="track-cta"><a href="https://dcsschools.com/pages/enrollment.php" class="btn-enroll-academics">Enroll Now &rarr;</a></div>
    </div>
  </section>
  <?php endforeach; ?>
  ...
  <section class="academics-info">
    <div class="container">
      ...
      <div class="activities-grid">
       ...
       <div class="gallery-row">
          <div class="gallery-card"><img src="../assets/images/extra1.png" alt="Secondary 1"></div>
          <div class="gallery-card"><img src="../assets/images/extra2.png" alt="Secondary 2"></div>
          <div class="gallery-card"><img src="../assets/images/extra3.png" alt="Secondary 3"></div>
        </div>
    </div>
  </section>
