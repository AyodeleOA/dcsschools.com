...
<body>
    ...
    <main>
        ...
        <section class="enrollment-hero">
            <h1 class="enrollment-title">Start your Application to Divine Confidence School</h1>
            <p class="enrollment-subtext">Thank you for your interest in Divine Confidence School. Please complete the form below to begin your child's admission process. Our admissions team will contact you shortly to guide you through the next steps.</p>
        </section>

        <!-- Form Section -->
        <section class="enrollment-form-section">
            <form class="enrollment-form" id="enrollmentForm" action="enrollment-handler.php" method="POST">
                ...
                <button type="submit" class="btn-submit-enroll" id="enroll-btn">Submit Application <span style="font-size: 18px;">&rarr;</span></button>
            </form>
        </div>
    </section>
