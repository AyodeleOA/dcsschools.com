...
<body>
  ...
  <section class="hero-section">
    <div class="hero-content-wrapper">
      <div class="hero-text">
        ...
        <div class="hero-buttons">
          <a href="https://dcsschools.com/pages/enrollment.php" class="btn-primary" target="_blank" rel="noopener">
            Apply for Admission &rarr;
          </a>
          <a href="https://dcsschools.com/pages/about.php" class="btn-secondary">
            Learn More &rarr;
          </a>
        </div>
      </div>
      <div class="hero-image-container">
        <!-- Placeholder image or existing one -->
        <img src="assets/images/hero.png" alt="Students" class="hero-img">
      </div>
    </div>
    ...
    <div class="contact-strip">
      <div class="contact-strip-content">
        ...
        <div class="contact-strip-item address-item">
        ...
        <a href="https://dcsschools.com/pages/enrollment.php" class="btn-enroll-strip">Enroll Now &rarr;</a>
      </div>
    </div>
  </section>

  <section class="welcome-section">
    <h2 class="section-title">Welcome to Divine Confidence School</h2>
    ...
    <div class="proprietress-area">
      <div class="proprietress-img-wrapper">
        <img src="assets/images/pro.png" alt="Proprietress" class="proprietress-img"> <!-- Placeholder -->
      </div>
      <a href="https://dcsschools.com/pages/about.php" class="btn-proprietress">Read More from Proprietress | Johnson F. B &rarr;</a>
    </div>
  ...
  <section class="academics-section">
    ...
    <div class="academic-cards-container">
      <!-- Preschool -->
      <div class="academic-card-new">
        <div class="academic-img-wrapper">
          <img src="assets/images/aca1.png" alt="Preschool" class="academic-img">
        </div>
        <a href="https://dcsschools.com/pages/academics.php" class="academic-link-btn">Preschool | Ages 2-5 &rarr;</a>
      </div>
      <!-- Primary -->
      <div class="academic-card-new">
        <div class="academic-img-wrapper">
        ...
        <a href="https://dcsschools.com/pages/about.php" class="academic-link-btn">Primary | Ages 6-11 &rarr;</a>
      </div>
      <!-- Secondary -->
      <div class="academic-card-new">
        <div class="academic-img-wrapper">
        ...
        <a href="https://dcsschools.com/pages/about.php" class="academic-link-btn">Secondary | Ages 12-17 &rarr;</a>
      </div>
    </div>
  </section>
  ...
  <section class="why-choose-us">
    ...
    <div class="features-circular-layout">
      <div class="center-circle-image">
        <img src="assets/images/cultural.png" alt="Students" class="circle-img">
      </div>
      ...
      <div class="feature-item item-1">
        ...
        <p>Our educators are professionally trained, carefully selected, and committed to nurturing every child's academic and personal growth.</p>
      </div>
  ...
  <section class="impact-section">
    <div class="impact-container">
      <h2 class="section-title-light">Our Impact in Numbers</h2>
      <div class="impact-content">
        ...
        <div class="impact-image-wrapper">
          <img src="assets/images/impact.png" alt="Impact" class="impact-img">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="photo-splash-section">
    <h2 class="section-title">Photo Splash</h2>
      ...
      <?php if (!empty($gallery_items)): ?>
        <?php foreach (array_slice($gallery_items, 0, 6) as $item): ?>
          <div class="gallery-item">
            <img src="<?php echo htmlspecialchars($item['image_path'] ?? ''); ?>" alt="Gallery Image">
          </div>
        <?php endforeach; ?>
      <?php else: ?>
        <div class="gallery-item"><img src="assets/images/group1.png" alt="Gallery"></div>
        <div class="gallery-item"><img src="assets/images/group2.png" alt="Gallery"></div>
        <div class="gallery-item"><img src="assets/images/group3.png" alt="Gallery"></div>
        <div class="gallery-item"><img src="assets/images/group1.png" alt="Gallery"></div>
        <div class="gallery-item"><img src="assets/images/group2.png" alt="Gallery"></div>
        <div class="gallery-item"><img src="assets/images/group3.png" alt="Gallery"></div>
      <?php endif; ?>
  ...
  <section class="testimonials-section">
    <div class="testimonial-container">
      <div class="testimonial-image-wrapper">
        <img src="assets/images/impact.png" alt="Testimonial Context" class="testimonial-img">
      </div>
  ...
  <section class="cta-section">
    <div class="cta-container">
      ...
      <a href="pages/enrollment.php" class="btn-cta-enroll">Enroll Now &rarr;</a>
    </div>
  </section>
